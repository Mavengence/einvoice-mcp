...
FIELD_TO_BT: dict[str, str] = {
    ...
    "due_date": "BT-9 (Fälligkeitsdatum)",
    "buyer_reference": "BT-10 (Käuferreferenz)",
    "leitweg_id": "BT-10 (Leitweg-ID)",
    "project_reference": "BT-11 (Projektreferenz)",
    "contract_reference": "BT-12 (Vertragsnummer)",
    "purchase_order_reference": "BT-13 (Bestellnummer)",
    "sales_order_reference": "BT-14 (Auftragsbestätigung)",
    "despatch_advice_reference": "BT-16 (Lieferscheinnummer)",
    "invoice_note": "BT-22 (Freitext-Bemerkung)",
    "payment_terms_text": "BT-20 (Zahlungsbedingungen)",
    "preceding_invoice_number": "BT-25 (Vorherige Rechnungsnr.)",
    "preceding_invoice_date": "BT-26 (Datum Vorrechnung)",
    "seller": "BG-4 (Verkäufer)",
    "seller.name": "BT-27 (Verkäufername)",
    "seller.trading_name": "BT-28 (Handelsname Verkäufer)",
    ...
    "seller.tax_number": "BT-32 (Steuernummer Verkäufer)",
    "seller.electronic_address": "BT-34 (Elektr. Adresse Verkäufer)",
    "seller.registration_id": "BT-29 (Handelsregister Verkäufer)",
    "buyer": "BG-7 (Käufer)",
    "buyer.name": "BT-44 (Käufername)",
    "buyer.trading_name": "BT-45 (Handelsname Käufer)",
    ...
    "buyer.tax_id": "BT-48 (USt-IdNr. Käufer)",
    "buyer.electronic_address": "BT-49 (Elektr. Adresse Käufer)",
    "items": "BG-25 (Rechnungsposition)",
    "payment_means_type_code": "BT-81 (Zahlungsart)",
    "remittance_information": "BT-83 (Verwendungszweck)",
